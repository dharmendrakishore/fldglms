...
left join kyc_details as kd on c.customer_id=kd.customer_id 
where c.customer_id=$customer_id";*/
//$query  = "select * from customer as c right join application as ap on (c.customer_id=ap.customer_id)where c.customer_id=$customer_id";
                ...
                <div class="col-md-5 d-flex align-items-center justify-content-end">
                  <div class="filter-box profile-filter-box">
                    ...
                    <form id="filter-form-profile" class="filter-form" action="" method="post">
                      ...
                      <div class="form-group select-field" id="sub-status-group"  name="sub-status-group" style="display:none">
                ...
                <div class="row">
                  <div class="col-md-4 col-lg-2 col-6">
                    ...
                    <span>&#8377; <?php 
                      ...
                      if(isset($profile_data[0]['loan_amount'])){
                        echo $profile_data[0]['loan_amount']; 
                      }else{
                        $profile_data[0]['loan_amount'] = '';
                      }
                    ?></span>
                  </div>
                  <div class="col-md-4 col-lg-2 col-6">
                    ...
                    if(isset($profile_data[0]['tenure'])){
                        echo $profile_data[0]['tenure']; 
                      }else{
                        $profile_data[0]['tenure'] = '';
                      }
                    ?></span>
                  </div>
                  <div class="col-md-4 col-lg-2 col-6">
