...
if(isset($_POST["customerID"]) && !empty($_POST["customerID"])){
    ...
    $cond .= " customer_id='".$_SESSION['application']['post_customerID']."'";
...
if(isset($_POST["customerName"]) && !empty($_POST["customerName"])) {
  ...
  $cond .= " name LIKE '%".$_SESSION['application']['post_customerName']."%'";
...
if(isset($_POST["mobile"]) && !empty($_POST["mobile"])){
  ...
  $cond .= " mobile='".$_SESSION['application']['post_mobile']."'";
 ...
 if( (isset($_POST["dateFrom"]) && !empty($_POST["dateFrom"])) || (isset($_POST["dateTo"]) && !empty($_POST["dateTo"])) ) {
     ...
     $cond .= " applied_date BETWEEN '".date("Y-m-d",strtotime($_POST["dateFrom"]))."' AND  '".date("Y-m-d",strtotime($_POST["dateTo"]))."'";
  }
  else if(!isset($p_cond)|| $p_cond==''){
...
if(isset($dateFrom) && isset($dateTo)){ 
    ...
    if(!empty($dateFrom)){
    $cond .= " applied_date BETWEEN '".date("Y-m-d",strtotime($dateFrom))."' AND  '".date("Y-m-d",strtotime($dateTo))."'";
  }
}
else if(!isset($p_cond)|| $p_cond==''){
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarToggler">
              <ul class="navbar-nav mt-2 mt-lg-0 justify-content-end">
                ...
                <li class="nav-item dropdown">
                  ...
                  <?php echo  $_SESSION["first_name"]."\n".$_SESSION["last_name"]; ?> <img src="images/Avatar.png" alt=""/>
                  </a>
              ...
              <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item <?php if($p>=$perpage_record-1){ echo 'disabled'; } ?>" >
                        <a class="page-link" href="?p=<?php echo $p+1;?> &from=<?php echo $dateFrom ?>&to=<?php echo $dateTo; ?>">Next</a>
                      </li>
                    </ul>
              </nav>
